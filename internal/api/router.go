...
// resolveDynamicRoute replaces numeric path segments with "_" to find
// SSG placeholder pages generated by Qwik's onStaticGenerate.
// e.g. /dashboard/projects/9 → /dashboard/projects/_/index.html
