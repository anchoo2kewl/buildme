      ...
      <div class="w-full max-w-sm rounded-lg border border-border bg-elevated p-8">
        ...
        <div class="mt-6 border-t border-border pt-4">
          <a
            ...
            class="flex w-full items-center justify-center gap-2 rounded-lg border border-border px-4 py-2 text-sm font-medium text-text transition-colors hover:border-accent"
          >
